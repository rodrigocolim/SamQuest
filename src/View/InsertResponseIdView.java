 ...
 * @author rodri
 */
public class InsertResponseIdView extends javax.swing.JFrame {

    InsertResponseIdControl control = InsertResponseIdControl.getInstance();

    /**
     * Creates new form InsertIdParticipant
     */
    public InsertResponseIdView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jIdField.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        jAdvance.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jAdvance, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(23, 23, 23)
    ...
    private void jAdvanceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAdvanceActionPerformed
        try {
            control.advanceToResponseView(Integer.parseInt(jIdField.getText()));
            close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertResponseIdView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InsertResponseIdView view = new InsertResponseIdView();
